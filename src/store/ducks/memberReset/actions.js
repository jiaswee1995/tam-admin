 ...
 * @author Shewn
 */
export const postResetMember = (data) => dispatch => {
    axios.post(process.env.REACT_APP_SLOT_URL + '/api/v1/admin/member/remove/secondary/password', data, {
        headers: {
