...
import {postWithdrawalList} from "../../../store/ducks/withdrawal/actions";
...
class withdrawApproval extends Component{
    constructor(props){
        super(props);
        this.state = {
            theme: 'dark',
        ...
        this.props.postWithdrawalList(data);
...
const mapStateToProps = (state) => {
    ...
    return {
        withdrawal_list_data : walletWithdrawal.data,
...
export default connect (mapStateToProps, mapDispatchToProps) (withdrawApproval);
